...
url --url="http://mirrors.edge.kernel.org/centos/8/BaseOS/x86_64/os/"
install
keyboard us
...
# Repositories to use
repo --name="Extras" --baseurl=http://mirrors.edge.kernel.org/centos/8/extras/x86_64/os/ --cost=100
## Uncomment for rolling builds
repo --name="AppStream" --baseurl=http://mirrors.edge.kernel.org/centos/8/AppStream/x86_64/os/ --cost=100
