...
url --url="http://mirrors.edge.kernel.org/centos/8/BaseOS/aarch64/os/"
install
keyboard us
...
# Repositories to use
repo --name="Extras" --baseurl=http://mirrors.edge.kernel.org/centos/8/extras/aarch64/os/ --cost=100
## Uncomment for rolling builds
repo --name="AppStream" --baseurl=http://mirrors.edge.kernel.org/centos/8/AppStream/aarch64/os/ --cost=100
